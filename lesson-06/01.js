...
const imageSlider = document.querySelector("#web-tech-image")
...
imageSlider.setAttribute("src", WEB_TECH_IMAGES[activeImageIndex])

function nextSlide () {

  if(activeImageIndex < WEB_TECH_IMAGES.length - 1){
    activeImageIndex += 1
  } else ( 
    activeImageIndex = 0
  )
...
function prevSlide () {
  if(activeImageIndex === 0){
    activeImageIndex = WEB_TECH_IMAGES.length - 1
  } else ( 
    activeImageIndex -= 1
  )
  imageSlider.setAttribute("src", WEB_TECH_IMAGES[activeImageIndex])
